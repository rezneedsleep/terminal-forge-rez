import { Wifi, Shield, Radio, Cpu, HardDrive, Monitor, Bluetooth, Zap, Link, BarChart2, Trash2 } from 'lucide-react';
  ...
  return (
    <section className="px-6 py-24 scroll-mt-20 section-animate">
      <div className="max-w-5xl mx-auto">
        ...
        {/* URL Shortener */}
        <div className="border border-border rounded-lg bg-card p-6 md:p-10 relative overflow-hidden" style={{ boxShadow: '0 0 15px hsl(230 60% 60% / 0.1), inset 0 0 15px hsl(230 60% 60% / 0.03)' }}>
